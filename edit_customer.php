...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `clientdetails`(`ClientName`, `MobileNumber`, `Society`, `Building`, `Flat`, `Address1`, `Address2`, `SecondName`, `SecondMobile`, `DisplayName`) VALUES ('$ClientName','$MobileNumber','$Society','$Building','$FlatNumber','$Address1','$Address2','$SecondName',' $SecondNumber','$DisplayName')";
    $result = mysqli_query($conn,$sql);

    if($result) {
        header("Location: add_customer.php?msg=New record created sucessfully");
    }
    else{
