...
if(isset($_POST['packing_date']))
{
 $query = "
 CALL upsPackingDetail ('".trim($_POST["packing_date"])."')";
...
{
 $query = "
 CALL upsOrdersDeliveredToday ('".trim($_POST["order_date"])."')";
...
if (isset($_POST['bill_summary_date'])) {
    $query1 = "
  CALL upsBillingSummary ('" . trim($_POST["bill_summary_date"]) . "')";
